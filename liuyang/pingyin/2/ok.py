...
# 读取Excel文件
excel_file = "your_excel_file.xlsx"  # 请将文件名替换为你的Excel文件名
...
# 获取列名和字段类型
columns = df.iloc[1:, 0].apply(lambda x: ''.join([''.join(i) for i in pinyin(x, style=Style.FIRST_LETTER, strict=False)])
